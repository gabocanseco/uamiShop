...
async function bootstrap() {
  ...
  SwaggerModule.setup('api/docs', app, document); // URL: http://localhost:3003/api/docs

  await app.listen(process.env.PORT ?? 3003);
  //console.log(`Swagger disponible en http://localhost:${process.env.PORT ?? 3003}/api/docs`);
}
bootstrap();
