...
import { ProductoInfoDto } from '@ventas/external-services/catalogo/dtos/producto-info.dto';
import { CatalogoApi } from '@ventas/external-services/catalogo/interfaces/catalogo.api';
