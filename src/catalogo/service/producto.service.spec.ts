...
describe('ProductoService', () => {
    ...
    beforeEach(async () => {
        ...
        productoRepo = module.get<ProductoInMemoryRepository>('IProductoRepository');
        categoriaRepo = module.get<CategoriaInMemoryRepository>('ICategoriaRepository');
    });
    ...
    describe('Producto', () => {
        ...
        it('debe lanzar EntityNotFoundException si el producto no existe', async () => {
            await expect(service.buscarPorId(ProductoId.generar())).rejects.toThrow(EntityNotFoundException);
        });
        ...
        it('debe actualizar un producto', async () => {
            ...
            const actualizado = await service.actualizar(producto.getId(), nuevoProducto);
