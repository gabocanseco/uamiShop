...
import {
  CarritoMapper,
  ProductoRefMapper,
} from '@ventas/controller/mappers/carrito.mapper';
import { ClienteParamDto } from '@app/shared/controller/dtos/cliente-params.dto';
import { ClienteMapper } from '@app/shared/controller/mappers/cliente.mapper';
import {
  CantidadDto,
  CarritoRequestDto,
} from '@ventas/controller/dtos/carrito-request.dto';
import { MoneyMapper } from '@app/shared/controller/mappers/money.mapper';
import {
  ApiTags,
  ApiOperation,
  ApiResponse,
...
import { CarritoProductoParamsDto } from '@ventas/controller/dtos/carrito-producto-params.dto';
...
export class CarritoController {
  ...
  async obtenerCarrito(
    ...
    const carritoDto = await this.carritoService.obtenerCarrito(carritoId);
